...
Metods like `paint::paint()`, `pillar::glimpse()`, and `str()` are pitched at
...
- it doesn't eturn the data it printed invisibly, unlike most methods intended to be used
for this purpose. This will cause flipping with flip() to stop as soon as this
method is hit.
